      ...
      <div>
        <br></br>
         ...
         <div className='button11'>
          <button className='btn btn-primary'  style={{ marginLeft: "10px" }} onClick ={this.addUser}>Add New User</button>
         </div>
         <div className='button12' >
          <button className='btn btn-primary'  style={{ marginLeft: "10px" }} onClick ={this.category}>Categories</button>
         </div>
         <div className='button13'>
          <button className='btn btn-primary'  style={{ marginLeft: "10px" }}onClick ={this.allPosts}>All Posts</button>
         </div>
