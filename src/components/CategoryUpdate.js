...
import update from '../assests/update.webp'
    ...
    return (
        <div>
         <div className='updateimage'>
          <div className='divinimage'>
          
          <div className="container">
          <div className="row">
            <div className="card col-md-6 offset-md-3 offset-md-3" id="formupdatecategory">
              <h3 className="text-center">Update Category</h3>
              <div className="card-body">
                <form>
                <div className="form-outline mb-4">
                    <div className="label5"> Category Title </div>
                    <input
                  ...
                  <div className="form-outline mb-4">
                  <div className="label5">Category Description </div>
                    <input
